...
class Ttabstract:
    ...
    def getdetails(self):
        ...
        self.gettimeday()
        df = pd.read_excel('Department_name.xlsx', header=None, skiprows=5, skipfooter=1, sheet_name=prof_code)
        ...
        try:
            ...
            return "Current location: " + update
        except:
            return "college time is over!"
